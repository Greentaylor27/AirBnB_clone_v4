$(document).ready(function () {
    ...
    $('button').click(function () {
        fetchPlaces({ amenities: Object.keys(checkingAmenities) });
    });
    ...
    function fetchPlaces(filters) {
        ...
        $.ajax({
            ...
            success: function (response) {
                console.log("Received some mail:", response);
                $('.places').empty();
                ...
                response.forEach(function (place) {
                    ...
                    var html = '<article>' +
                        ...
                        '</article>';
                    $('.places').append(html);
                    console.log("Appended too DOM:", place.name);
                });
            },
            error: function (xhr, status, error) {
                console.error("No places:", error);
            }
        });
    }
});